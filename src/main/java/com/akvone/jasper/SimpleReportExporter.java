...
public class SimpleReportExporter {
    ...
    public void exportToPdf(String fileName, String author, OutputStream output) {
    ...
    public void exportToDocx(String fileName, String author, OutputStream output) {
